...
func TestFilesystemFetcher_FetchInputs_TextFile(t *testing.T) {
	...
	t.Run("text file without permissions", func(t *testing.T) {
		input := scanner.NewFileInput("testfile", testFile, "text", false, false)
	...
	t.Run("text file with permissions", func(t *testing.T) {
		input := scanner.NewFileInput("testfile", testFile, "text", false, true)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
...
func TestFilesystemFetcher_FetchInputs_JSONFile(t *testing.T) {
	...
	t.Run("json file without permissions", func(t *testing.T) {
		input := scanner.NewFileInput("config", testFile, "json", false, false)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
	...
	t.Run("json file with permissions", func(t *testing.T) {
		input := scanner.NewFileInput("config", testFile, "json", false, true)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
...
func TestFilesystemFetcher_FetchInputs_YAMLFile(t *testing.T) {
	...
	t.Run("yaml file without permissions", func(t *testing.T) {
		input := scanner.NewFileInput("config", testFile, "yaml", false, false)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
	...
	t.Run("yaml file with permissions", func(t *testing.T) {
		input := scanner.NewFileInput("config", testFile, "yaml", false, true)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
...
func TestFilesystemFetcher_FetchInputs_Directory(t *testing.T) {
	...
	t.Run("directory without recursion", func(t *testing.T) {
		input := scanner.NewFileInput("files", tempDir, "text", false, false)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
	...
	t.Run("directory with recursion", func(t *testing.T) {
		input := scanner.NewFileInput("files", tempDir, "text", true, false)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
	...
	t.Run("directory with permissions", func(t *testing.T) {
		input := scanner.NewFileInput("files", tempDir, "text", false, true)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
...
func TestFilesystemFetcher_FetchInputs_FormatFiltering(t *testing.T) {
	...
	t.Run("json format filtering", func(t *testing.T) {
		input := scanner.NewFileInput("configs", tempDir, "json", false, false)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
	...
	t.Run("yaml format filtering", func(t *testing.T) {
		input := scanner.NewFileInput("configs", tempDir, "yaml", false, false)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
	...
	t.Run("text format includes all", func(t *testing.T) {
		input := scanner.NewFileInput("configs", tempDir, "text", false, false)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
...
func TestFilesystemFetcher_FetchInputs_Errors(t *testing.T) {
	...
	t.Run("nonexistent file", func(t *testing.T) {
		input := scanner.NewFileInput("missing", "/nonexistent/file.txt", "text", false, false)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
	...
	t.Run("invalid json", func(t *testing.T) {
		...
		input := scanner.NewFileInput("invalid", testFile, "json", false, false)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
	...
	t.Run("invalid yaml", func(t *testing.T) {
		...
		input := scanner.NewFileInput("invalid", testFile, "yaml", false, false)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
	...
	t.Run("wrong input type", func(t *testing.T) {
		input := scanner.NewKubernetesInput("pods", "", "v1", "pods", "", "")
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
	...
	t.Run("invalid input spec", func(t *testing.T) {
		...
		mockInput := &scanner.InputImpl{
			InputName: "test",
			InputType: scanner.InputTypeFile,
			InputSpec: &scanner.KubernetesInput{}, // Wrong spec type
		}

		result, err := fetcher.FetchInputs([]scanner.Input{mockInput}, nil)
...
func TestFilesystemFetcher_FetchInputs_SpecialPermissions(t *testing.T) {
	...
	t.Run("restricted file permissions", func(t *testing.T) {
		input := scanner.NewFileInput("restricted", testFile, "text", false, true)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
	...
	t.Run("executable file permissions", func(t *testing.T) {
		input := scanner.NewFileInput("script", execFile, "text", false, true)
		result, err := fetcher.FetchInputs([]scanner.Input{input}, nil)
...
func TestValidateFileInputSpec(t *testing.T) {
	tests := []struct {
		name    string
		spec    scanner.FileInputSpec
		wantErr bool
		errMsg  string
	}{
		{
			name: "valid spec",
			spec: &scanner.FileInput{
...
func TestFilesystemFetcher_Integration(t *testing.T) {
	...
	t.Run("complex directory structure with permissions", func(t *testing.T) {
		...
		inputs := []scanner.Input{
			scanner.NewFileInput("app_config", appConfig, "yaml", false, true),
			scanner.NewFileInput("db_config", dbConfig, "json", false, true),
			scanner.NewFileInput("all_configs", configDir, "yaml", false, true),
			scanner.NewFileInput("logs", logsDir, "text", false, false),
		}
...
func BenchmarkFilesystemFetcher_FetchTextFile(b *testing.B) {
	...
	fetcher := NewFilesystemFetcher("")
	input := scanner.NewFileInput("test", testFile, "text", false, false)
...
func BenchmarkFilesystemFetcher_FetchWithPermissions(b *testing.B) {
	...
	fetcher := NewFilesystemFetcher("")
	input := scanner.NewFileInput("test", testFile, "text", false, true)
